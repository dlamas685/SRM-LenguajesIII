(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            ...
            maxLength: 'Tenga cuidado, su etiqueta no debe exceder %s caracteres.',
            max: 'Advertencia, el número de items no debe exceder a %s.',
            email: 'Advertencia, la dirección de correo electrónico que ingresó no es válida',
            exists: 'Advertencia, este item ya existe!',
            autocomplete_only: 'Tenga cuidado, debe seleccionar un valor de la lista.',
            timeout: 2000
        }
    };
